        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card text-center h-100 position-relative">
                    <button class="btn position-absolute top-0 end-0 m-2 fs-2 text-transparent border-0" title="Agregar a favoritos">🤍</button>
                    <img src="assets/img/Iphone.png" class="card-img-top object-fit-contain img-tarjetas" alt="iPhone 16 Pro">
                    <div class="card-body">
                        <span class="badge mb-2 bg-warning">ENVÍO GRATIS</span>
                        <h4>$174.999</h4>
                        <p class="text-muted small">Precio sin impuestos nacionales $144.627,27</p>
                        <p>Apple iPhone 16 Pro 256GB eSim</p>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card text-center h-100 position-relative">
                    <button class="btn position-absolute top-0 end-0 m-2 fs-2 text-transparent border-0" title="Agregar a favoritos">🤍</button>
                    <img src="assets/img/galaxya56.png" class="card-img-top object-fit-contain img-tarjetas" alt="Galaxy A56">
                    <div class="card-body">
                        <span class="badge mb-2 bg-success">¡NUEVO!</span>
                        <h4>$199.999</h4>
                        <p class="text-muted small">Precio sin impuestos nacionales $165.289,26</p>
                        <p>Samsung Galaxy A56 5G 256GB Ram 8GB Dual Sim</p>
                        <a href="#" class="btn btn-dark w-100">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card text-center h-100 position-relative">
                    <button class="btn position-absolute top-0 end-0 m-2 fs-2 text-transparent border-0" title="Agregar a favoritos">🤍</button>
                    <img src="assets/img/redmi-note-13-pro.png" class="card-img-top object-fit-contain img-tarjetas" alt="Redmi 13 Pro">
                    <div class="card-body">
                        ...
                        <p>Xiaomi Redmi 13 Pro 128GB 5G Dual Sim</p>
                        <a href="#" class="btn btn-dark w-100">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card text-center h-100 position-relative">
                    <button class="btn position-absolute top-0 end-0 m-2 fs-2 text-transparent border-0" title="Agregar a favoritos">🤍</button>
                    <img src="assets/img/galaxya36.png" class="card-img-top object-fit-contain img-tarjetas" alt="Galaxy A36">
                    <div class="card-body">
                        <span class="badge mb-2 bg-warning">ENVÍO GRATIS</span>
                        <h4>$174.999</h4>
                        <p class="text-muted small">Precio sin impuestos nacionales $144.627,27</p>
                        <p>Samsung Galaxy A36 5G 256GB Ram 8GB Dual Sim</p>
                        <a href="#" class="btn btn-dark w-100">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card text-center h-100 position-relative">
                    <button class="btn position-absolute top-0 end-0 m-2 fs-2 text-transparent border-0" title="Agregar a favoritos">🤍</button>
                    <img src="assets/img/iphone16.png" class="card-img-top object-fit-contain img-tarjetas" alt="iPhone 16">
                    <div class="card-body">
                        <span class="badge mb-2 bg-success">¡NUEVO!</span>
                        <h4>$199.999</h4>
                        <p class="text-muted small">Precio sin impuestos nacionales $165.289,26</p>
                        <p>Apple iPhone 16 128GB nanoSim</p>
                        <a href="#" class="btn btn-dark w-100">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card text-center h-100 position-relative">
                    <button class="btn position-absolute top-0 end-0 m-2 fs-2 text-transparent border-0" title="Agregar a favoritos">🤍</button>
                    <img src="assets/img/googlepixel.png" class="card-img-top object-fit-contain img-tarjetas" alt="Pixel Pro XL">
                    <div class="card-body">
                        <span class="badge mb-2 bg-primary">STOCK LIMITADO</span>
                        <h4>$229.999</h4>
                        <p class="text-muted small">Precio sin impuestos nacionales $189.914,31</p>
                        <p>Google Pixel Pro XL 256GB DualSim</p>
                        <a href="#" class="btn btn-dark w-100">Agregar al carrito</a>
                    </div>
                </div>
            </div>
