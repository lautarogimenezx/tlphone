        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card text-center h-100 position-relative">
                    ...
                    <img src="assets/img/reloj1.png" class="card-img-top object-fit-contain img-tarjetas" alt="Apple whatch SE">
                    <div class="card-body">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card text-center h-100 position-relative">
                    <button class="btn position-absolute top-0 end-0 m-2 fs-2 border-0 bg-transparent" title="Agregar a favoritos">🤍</button>
                    <img src="assets/img/reloj2.png" class="card-img-top object-fit-contain img-tarjetas" alt="Apple whatch Ultra">
                    <div class="card-body">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card text-center h-100 position-relative">
                    <button class="btn position-absolute top-0 end-0 m-2 fs-2 border-0 bg-transparent" title="Agregar a favoritos">❤️</button>
                    <img src="assets/img/reloj4.png" class="card-img-top object-fit-contain img-tarjetas" alt="Galaxy Watch 5">
                    <div class="card-body">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card text-center h-100 position-relative">
                    <button class="btn position-absolute top-0 end-0 m-2 fs-2 border-0 bg-transparent" title="Agregar a favoritos">🤍</button>
                    <img src="assets/img/reloj5.png" class="card-img-top object-fit-contain img-tarjetas" alt="Huawei Watch GT5">
                    <div class="card-body">
                        <span class="badge mb-2 bg-warning">ENVÍO GRATIS</span>
                        <h4>$174.999</h4>
                        <p class="text-muted small">Precio sin impuestos nacionales $144.627,27</p>
                        <p>Huawei Watch GT5</p>
                        <a href="#" class="btn btn-dark w-100">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card text-center h-100 position-relative">
                    <button class="btn position-absolute top-0 end-0 m-2 fs-2 border-0 bg-transparent" title="Agregar a favoritos">🤍</button>
                    <img src="assets/img/reloj3.png" class="card-img-top object-fit-contain img-tarjetas" alt="Galaxy fit 3">
                    <div class="card-body">
                        <span class="badge mb-2 bg-success">¡NUEVO!</span>
                        <h4>$199.999</h4>
                        <p class="text-muted small">Precio sin impuestos nacionales $165.289,26</p>
                        <p>Samsung Galaxy Fit 3</p>
                        <a href="#" class="btn btn-dark w-100">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card text-center h-100 position-relative">
                    <button class="btn position-absolute top-0 end-0 m-2 fs-2 border-0 bg-transparent" title="Agregar a favoritos">🤍</button>
                    <img src="assets/img/reloj6.png" class="card-img-top object-fit-contain img-tarjetas" alt="Xiaomi Mi band 8">
                    <div class="card-body">
                        <span class="badge mb-2 bg-primary">STOCK LIMITADO</span>
                        <h4>$229.999</h4>
                        <p class="text-muted small">Precio sin impuestos nacionales $189.914,31</p>
                        <p>Xiaomi Mi Band 8</p>
                        <a href="#" class="btn btn-dark w-100">Agregar al carrito</a>
                    </div>
                </div>
            </div>
