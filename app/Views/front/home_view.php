...
<section>
    ...
    <div class="row g-4">
        ...
        <div class="card text-center h-100 position-relative">
            ...
            style="z-index: 1; font-size: 2rem; background-color: transparent; border: none;"
            title="Agregar a favoritos">🤍
            </button>
            <img src="assets/img/auricularess.png" class="card-img-top" alt="AirPods Max" style="object-fit: contain; height: 300px;">
            <div class="card-body">
            <span class="badge mb-2" style="background-color: #a259ff;">ENVÍO GRATIS</span>
            <h4>$174.999</h4>
        ...
        <div class="card text-center h-100 position-relative">
            <button class="btn position-absolute top-0 end-0 m-2"
            style="z-index: 1; font-size: 2rem; background-color: transparent; border: none;"
            title="Agregar a favoritos">❤️
            </button>
            <img src="assets/img/parlante5.png" class="card-img-top" alt="JBL Flip 6"
        ...
        <div class="card text-center h-100 position-relative">
            ...
            <img src="assets/img/fundaip.png" class="card-img-top" alt="Funda iPhone 16 Pro Max" style="object-fit: contain; height: 300px;">
            <div class="card-body">
